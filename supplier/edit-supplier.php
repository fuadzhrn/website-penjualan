...
$title = "Edit Suplier - Website Penjualan";
    ...
    <div class="container-fluid">
        <div class="card">
            ...
            <div class="card-header">
                <h3 class="card-title"><i class="fas fa-plus fa-sm pr-2"></i> Edit Supplier</h3>
                <button type="submit" name="update" class="btn btn-primary btn-sm float-right">
                <i class="fas fa-bookmark pr-2"></i>Perbarui
                            </button>
