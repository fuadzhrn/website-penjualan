...
$title = "Edit User - Website Penjualan";
    ...
    <div class="container-fluid">
        <div class="card">
            ...
            <div class="card-header">
                ...
                <i class="fas fa-bookmark pr-2"></i>Koreksi
                            </button>
            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-lg-4 text-center">
                        ...
                        <img src="<?= $main_url ?>asset/image/<?= $user['foto'] ?>" class="profile-user-img img-circle mb-3"name="image" alt="">
