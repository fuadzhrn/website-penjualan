...
if (isset($_POST['login'])) {
    ...
    if (mysqli_num_rows($queryLogin) === 1) {
        ...
        if (password_verify($password, $row['password'])) {
            ...
            // Jika ingin menyimpan sesi, bisa ditambahkan session_start() dan $_SESSION
            header("Location: ../dashboard.php");
            exit();
        } else {
...
<div class="login-box slide-down" style="margin-top: -70px;">
  ...
  <div class="card card-outline card-primary">
    <div class="card-header text-center">
      <a href="#" class="h1"><b>Website</b>Penjualan</a>
    </div>
    <div class="card-body">
      ...
      <p class="my-3 text-center">
        <strong>Copyright &copy; 2025 <span class="text-info">Fuad Zahran</span></strong>
      </p>
    </div>
    <!-- /.card-body -->
  </div>
