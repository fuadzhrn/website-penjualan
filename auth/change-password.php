...
$title = "Change Password - Website penjualan";
            ...
            <div class="card">
                <form action="" method="post">
                    <div class="card-header">
                        ...
                        <button type="submit" name="simpan" class="btn btn-primary btn-sm float-right"><i class="fas fa-pen"></i> Submit</button>
                        <button type="reset" name="reset" class="btn btn-danger btn-sm float-right mr-1"><i class="fas fa-exclamation"></i> Reset</button>
                    </div>
                    <div class="card-body">
